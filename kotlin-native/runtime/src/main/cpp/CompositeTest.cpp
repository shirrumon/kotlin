...
using C323232 = composite::descriptor::Composite<composite::descriptor::Reg<int32_t>, composite::descriptor::Reg<int32_t>, composite::descriptor::Reg<int32_t>>;
...
using C643232 = composite::descriptor::Composite<composite::descriptor::Reg<int64_t>, composite::descriptor::Reg<int32_t>, composite::descriptor::Reg<int32_t>>;
...
using C326432 = composite::descriptor::Composite<composite::descriptor::Reg<int32_t>, composite::descriptor::Reg<int64_t>, composite::descriptor::Reg<int32_t>>;
...
using C323264 = composite::descriptor::Composite<composite::descriptor::Reg<int32_t>, composite::descriptor::Reg<int32_t>, composite::descriptor::Reg<int64_t>>;
...
using CEmpty326432 = composite::descriptor::Composite<CEmpty, composite::descriptor::Reg<int32_t>, composite::descriptor::Reg<int64_t>, composite::descriptor::Reg<int32_t>>;
...
using C32Empty6432 = composite::descriptor::Composite<composite::descriptor::Reg<int32_t>, CEmpty, composite::descriptor::Reg<int64_t>, composite::descriptor::Reg<int32_t>>;
...
using C3264Empty32 = composite::descriptor::Composite<composite::descriptor::Reg<int32_t>, composite::descriptor::Reg<int64_t>, CEmpty, composite::descriptor::Reg<int32_t>>;
...
using C326432Empty = composite::descriptor::Composite<composite::descriptor::Reg<int32_t>, composite::descriptor::Reg<int64_t>, composite::descriptor::Reg<int32_t>, CEmpty>;
...
TEST(CompositeTest, VLADescriptor) {
    ...
    void* ptr = reinterpret_cast<void*>(uintptr_t(256));
    auto [f0, f0Ptr] = comp.field<0>(ptr);
    static_assert(std::is_same_v<decltype(f0), composite::descriptor::Reg<int32_t>>);
    EXPECT_THAT(f0Ptr, ptr);
    auto [f1, f1Ptr] = comp.field<1>(ptr);
    EXPECT_THAT(f1.alignment(), dyn.alignment());
    EXPECT_THAT(f1.size(), dyn.size());
    EXPECT_THAT(f1Ptr, static_cast<uint8_t*>(ptr) + sizeof(void*));
}
