...
TYPED_TEST_P(TracingGCTest, WeakResuractionAtMarkTermination) {
...
REGISTER_TYPED_TEST_SUITE_WITH_LISTS(TracingGCTest, TRACING_GC_TEST_LIST, WeakResuractionAtMarkTermination);
