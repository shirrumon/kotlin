...
public class DefaultErrorMessages {
    ...
    static {
        ...
        MAP.put(IMPLICIT_ACTUALIZATION_BY_SUPER_CLASS, "Expected {0} is implicitly actualized by super class in module {1}. " +
                                                       "Please use explicit ''actual override''. See: https://youtrack.jetbrains.com/issue/KT-58544",
