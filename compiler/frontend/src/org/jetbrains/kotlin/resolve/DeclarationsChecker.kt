...
class DeclarationsChecker(
    ...
    private fun checkActualTypeAlias(declaration: KtTypeAlias, typeAliasDescriptor: TypeAliasDescriptor) {
        ...
        if (languageVersionSettings.supportsFeature(LanguageFeature.ProhibitActualTypealiasToNothingAndNullable)) {
            if (rhs.isNothing()) {
    ...
    private fun checkExpectDeclarationModifiers(declaration: KtDeclaration, descriptor: MemberDescriptor) {
        ...
        if (declaration is KtFunction && languageVersionSettings.supportsFeature(LanguageFeature.ProhibitExpectActualTailrecOrExternal)) {
    ...
    private fun checkExpectDeclarationHasNoExternalModifier(declaration: KtDeclaration) {
        if (languageVersionSettings.supportsFeature(LanguageFeature.ProhibitExpectActualTailrecOrExternal)) {
