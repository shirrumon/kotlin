...
@An
interface B : A {
    override val p1: <!PROPERTY_TYPE_MISMATCH_ON_OVERRIDE("p1; val p1: @R|An|()  String")!>Int<!>
    @An
    ...
    override fun test(arg: String): <!RETURN_TYPE_MISMATCH_ON_OVERRIDE("test; fun test(arg: @R|An|()  String): @R|An|()  String")!>Int<!>
}

interface C : A {
    override var p2: <!VAR_TYPE_MISMATCH_ON_OVERRIDE("p2; var p2: @R|An|()  String")!>Int<!>
}
