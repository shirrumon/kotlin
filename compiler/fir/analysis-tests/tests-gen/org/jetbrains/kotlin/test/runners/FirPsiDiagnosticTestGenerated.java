...
public class FirPsiDiagnosticTestGenerated extends AbstractFirPsiDiagnosticTest {
    ...
    public class Resolve {
        ...
        public class Scripts {
            ...
            @Test
            @TestMetadata("scriptShouldBeInvisibleFromOtherSources.kts")
            public void testScriptShouldBeInvisibleFromOtherSources() throws Exception {
                runTest("compiler/fir/analysis-tests/testData/resolve/scripts/scriptShouldBeInvisibleFromOtherSources.kts");
            }
        }
