...
public class FirOldFrontendMPPDiagnosticsWithPsiTestGenerated extends AbstractFirPsiWithActualizerDiagnosticsTest {
    ...
    public class ActualClassifierMustHasTheSameMembersAsNonFinalExpectClassifierChecker {
        ...
        public void testInjectConstructor() throws Exception {
            runTest("compiler/testData/diagnostics/tests/multiplatform/actualClassifierMustHasTheSameMembersAsNonFinalExpectClassifierChecker/injectConstructor.kt");
        }
        ...
        @Test
        @TestMetadata("injectMethod_viaJava.kt")
        public void testInjectMethod_viaJava() throws Exception {
            runTest("compiler/testData/diagnostics/tests/multiplatform/actualClassifierMustHasTheSameMembersAsNonFinalExpectClassifierChecker/injectMethod_viaJava.kt");
        }
