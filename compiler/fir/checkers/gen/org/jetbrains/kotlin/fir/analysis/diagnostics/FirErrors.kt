...
object FirErrors {
    ...
    val ACTUAL_CLASSIFIER_MUST_HAVE_THE_SAME_MEMBERS_AS_NON_FINAL_EXPECT_CLASSIFIER by error3<KtClassLikeDeclaration, FirClassLikeSymbol<*>, Set<ExpectActualMemberDiff<FirCallableSymbol<*>, FirClassSymbol<*>>>, FirClassSymbol<*>>(SourceElementPositioningStrategies.DECLARATION_NAME)
    ...
    val SETTER_VISIBILITY_CHANGED_IN_NON_FINAL_EXPECT_CLASSIFIER_ACTUALIZATION by error1<KtPropertyAccessor, ExpectActualMemberDiff<FirCallableSymbol<*>, FirClassSymbol<*>>>(SourceElementPositioningStrategies.VISIBILITY_MODIFIER)
    val PARAMETER_NAME_CHANGED_IN_NON_FINAL_EXPECT_CLASSIFIER_ACTUALIZATION by error1<KtCallableDeclaration, ExpectActualMemberDiff<FirCallableSymbol<*>, FirClassSymbol<*>>>(SourceElementPositioningStrategies.DECLARATION_NAME)
    val PROPERTY_KIND_CHANGED_IN_NON_FINAL_EXPECT_CLASSIFIER_ACTUALIZATION by error1<KtCallableDeclaration, ExpectActualMemberDiff<FirCallableSymbol<*>, FirClassSymbol<*>>>(SourceElementPositioningStrategies.VAL_OR_VAR_NODE)
    val LATEINIT_CHANGED_IN_NON_FINAL_EXPECT_CLASSIFIER_ACTUALIZATION by error1<KtCallableDeclaration, ExpectActualMemberDiff<FirCallableSymbol<*>, FirClassSymbol<*>>>(SourceElementPositioningStrategies.LATEINIT_MODIFIER)
    val TYPE_PARAMETER_NAMES_CHANGED_IN_NON_FINAL_EXPECT_CLASSIFIER_ACTUALIZATION by error1<KtCallableDeclaration, ExpectActualMemberDiff<FirCallableSymbol<*>, FirClassSymbol<*>>>(SourceElementPositioningStrategies.TYPE_PARAMETERS_LIST)
