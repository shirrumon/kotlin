...
object FirExpectActualDeclarationChecker : FirBasicDeclarationChecker() {
    ...
    private fun checkExpectDeclarationModifiers(
        ...
        if (context.languageVersionSettings.supportsFeature(LanguageFeature.ProhibitExpectActualTailrecOrExternal) &&
    ...
    private fun checkIfExpectHasDefaultArgumentsAndActualizedWithTypealias(
        ...
        if (!context.languageVersionSettings.supportsFeature(LanguageFeature.ProhibitActualTypealiasIfExpectHasDefaultParams)) return
    ...
    private fun checkAnnotationsMatch(
        ...
        if (!context.languageVersionSettings.supportsFeature(LanguageFeature.ProhibitDifferentAnnotationsOnExpectAndActual)) return
    ...
    private fun checkOptInAnnotation(
        ...
        if (context.languageVersionSettings.supportsFeature(LanguageFeature.ProhibitExpectActualOptInAnnotations) &&
