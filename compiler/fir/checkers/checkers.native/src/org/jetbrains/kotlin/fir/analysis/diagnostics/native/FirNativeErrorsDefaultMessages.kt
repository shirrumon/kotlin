...
object FirNativeErrorsDefaultMessages : BaseDiagnosticRendererFactory() {
    override val MAP = KtDiagnosticFactoryToRendererMap("FIR").also { map ->
        ...
        map.put(
            ...
            "Conflicting overloads: {0}. Add @ExperimentalObjCOverride to allow collision for functions inherited from Objective-C.",
            SYMBOLS
        )
        map.put(
            INAPPLICABLE_OBJC_OVERRIDE,
            "@ExperimentalObjCOverride is only allowed on functions inherited from Objective-C.",
        )
    }
}
