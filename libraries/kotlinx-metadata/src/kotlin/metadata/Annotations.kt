 ...
 */
public class KmAnnotation(public val className: kotlin.metadata.ClassName, public val arguments: Map<String, kotlin.metadata.KmAnnotationArgument>) {
    ...
    override fun equals(other: Any?): Boolean =
        this === other || other is kotlin.metadata.KmAnnotation && className == other.className && arguments == other.arguments
...
public sealed class KmAnnotationArgument {
     ...
     */
    public sealed class LiteralValue<out T : Any> : kotlin.metadata.KmAnnotationArgument() {
        /**
        ...
        final override fun toString(): String =
            "${this::class.java.simpleName}(${if (this is kotlin.metadata.KmAnnotationArgument.StringValue) "\"$value\"" else value.toString()})"
    }
    ...
    public data class ByteValue(override val value: Byte) : kotlin.metadata.KmAnnotationArgument.LiteralValue<Byte>()
    /** An annotation argument with a [Char] type. */
    public data class CharValue(override val value: Char) : kotlin.metadata.KmAnnotationArgument.LiteralValue<Char>()
    /** An annotation argument with a [Short] type. */
    public data class ShortValue(override val value: Short) : kotlin.metadata.KmAnnotationArgument.LiteralValue<Short>()
    /** An annotation argument with a [Int] type. */
    public data class IntValue(override val value: Int) : kotlin.metadata.KmAnnotationArgument.LiteralValue<Int>()
    /** An annotation argument with a [Long] type. */
    public data class LongValue(override val value: Long) : kotlin.metadata.KmAnnotationArgument.LiteralValue<Long>()
    /** An annotation argument with a [Float] type. */
    public data class FloatValue(override val value: Float) : kotlin.metadata.KmAnnotationArgument.LiteralValue<Float>()
    /** An annotation argument with a [Double] type. */
    public data class DoubleValue(override val value: Double) : kotlin.metadata.KmAnnotationArgument.LiteralValue<Double>()
    /** An annotation argument with a [Boolean] type. */
    public data class BooleanValue(override val value: Boolean) : kotlin.metadata.KmAnnotationArgument.LiteralValue<Boolean>()

    /** An annotation argument with a [UByte] type. */
    public data class UByteValue(override val value: UByte) : kotlin.metadata.KmAnnotationArgument.LiteralValue<UByte>()
    /** An annotation argument with a [UShort] type. */
    public data class UShortValue(override val value: UShort) : kotlin.metadata.KmAnnotationArgument.LiteralValue<UShort>()
    /** An annotation argument with a [UInt] type. */
    public data class UIntValue(override val value: UInt) : kotlin.metadata.KmAnnotationArgument.LiteralValue<UInt>()
    /** An annotation argument with a [ULong] type. */
    public data class ULongValue(override val value: ULong) : kotlin.metadata.KmAnnotationArgument.LiteralValue<ULong>()

    /** An annotation argument with a [String] type. */
    public data class StringValue(override val value: String) : kotlin.metadata.KmAnnotationArgument.LiteralValue<String>()
     ...
     */
    public data class EnumValue(val enumClassName: kotlin.metadata.ClassName, val enumEntryName: String) : kotlin.metadata.KmAnnotationArgument() {
     ...
     */
    public data class AnnotationValue(val annotation: kotlin.metadata.KmAnnotation) : kotlin.metadata.KmAnnotationArgument() {
     ...
     */
    public data class ArrayValue(val elements: List<kotlin.metadata.KmAnnotationArgument>) : kotlin.metadata.KmAnnotationArgument() {
    ...
    ) : kotlin.metadata.KmAnnotationArgument() {
        public constructor(className: kotlin.metadata.ClassName) : this(className, 0)
     ...
     */
    public data class ArrayKClassValue(val className: kotlin.metadata.ClassName, val arrayDimensionCount: Int) : kotlin.metadata.KmAnnotationArgument() {
        init {
