...
abstract class KlibFunctionExtensionVisitor : KmFunctionExtensionVisitor {
    ...
    abstract fun visitAnnotation(annotation: kotlin.metadata.KmAnnotation)
...
abstract class KlibPropertyExtensionVisitor : KmPropertyExtensionVisitor {
    ...
    abstract fun visitGetterAnnotation(annotation: kotlin.metadata.KmAnnotation)

    abstract fun visitSetterAnnotation(annotation: kotlin.metadata.KmAnnotation)

    abstract fun visitFile(file: Int)

    abstract fun visitUniqId(uniqId: UniqId)

    abstract fun visitCompileTimeValue(value: kotlin.metadata.KmAnnotationArgument)
