...
internal class KlibFunctionExtension : KlibFunctionExtensionVisitor(), KmFunctionExtension {
    ...
    val annotations: MutableList<kotlin.metadata.KmAnnotation> = mutableListOf()
    ...
    override fun visitAnnotation(annotation: kotlin.metadata.KmAnnotation) {
...
internal class KlibPropertyExtension : KlibPropertyExtensionVisitor(), KmPropertyExtension {
    ...
    val annotations: MutableList<kotlin.metadata.KmAnnotation> = mutableListOf()
    val getterAnnotations: MutableList<kotlin.metadata.KmAnnotation> = mutableListOf()
    val setterAnnotations: MutableList<kotlin.metadata.KmAnnotation> = mutableListOf()
    var uniqId: UniqId? = null
    var file: Int? = null
    var compileTimeValue: kotlin.metadata.KmAnnotationArgument? = null

    override fun visitAnnotation(annotation: kotlin.metadata.KmAnnotation) {
        annotations += annotation
    }

    override fun visitGetterAnnotation(annotation: kotlin.metadata.KmAnnotation) {
        getterAnnotations += annotation
    }

    override fun visitSetterAnnotation(annotation: kotlin.metadata.KmAnnotation) {
    ...
    override fun visitCompileTimeValue(value: kotlin.metadata.KmAnnotationArgument) {
