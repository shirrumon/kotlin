...
abstract class ScriptingIT : KGPBaseTest() {
    ...
    open fun testScripting(gradleVersion: GradleVersion) {
        project("scripting", gradleVersion) {
            ...
            appSubProject.maybeDisableLightTree()
            scriptTemplateSubProject.maybeDisableLightTree()
    ...
    open fun GradleProject.maybeDisableLightTree() {
...
class ScriptingK2IT : ScriptingIT() {
    ...
    override fun GradleProject.maybeDisableLightTree() {
        buildGradle.append(
            """
