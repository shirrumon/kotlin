...
internal class FirTowerDataContextAllElementsCollector : FirResolveContextCollector, FirTowerContextProvider {
    ...
    override fun addStatementContext(statement: FirStatement, context: BodyResolveContext) {
        val closestParentExpression = statement.psi?.closestParentExpressionWithTheSameContextOrSelf() ?: return
...
private tailrec fun PsiElement.closestParentExpressionWithTheSameContextOrSelf(): KtExpression? {
    ...
    return parent?.closestParentExpressionWithTheSameContextOrSelf()
}
