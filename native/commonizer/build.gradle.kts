...
dependencies {
    embedded(project(":kotlin-metadata-klib")) { isTransitive = false }
    ...
    compileOnly(project(":kotlin-metadata-klib")) { isTransitive = false }
    ...
    testImplementation(project(":kotlin-metadata-klib")) { isTransitive = false }
