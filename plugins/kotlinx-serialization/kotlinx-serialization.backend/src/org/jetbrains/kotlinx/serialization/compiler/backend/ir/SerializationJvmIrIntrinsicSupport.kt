...
class SerializationJvmIrIntrinsicSupport(
    ...
    private fun InstructionAdapter.moduleOverPolymorphic(serializer: IrClassSymbol, kType: IrType, intrinsicType: IntrinsicType): Boolean {
    ...
    private fun stackValueSerializerInstance(
        ...
        if (iv.moduleOverPolymorphic(serializer, kType, intrinsicType)) return true
